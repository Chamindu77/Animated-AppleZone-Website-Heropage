...
import { FaFacebook, FaInstagram, FaTwitter } from "react-icons/fa"; // Removed FaMessage import
...
const Hero = () => {
  ...
  return (
    <motion.section
      ...
      animate={{
        backgroundImage: `radial-gradient(circle, ${activeData.bgColor}aa
    ...
    >
      <Navbar />
      <div className="container grid grid-cols-1 md:grid-cols-2 h-screen md:h-[649px] relative">
        ...
        <div className="flex flex-col items-center justify-center order-1 md:order-2">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              transition={{ duration: 0.4, ease: easeInOut, delay: 0 }}
              exit={{ opacity: 0 }}
              className="text-[300px] absolute top-0 left-1/2-translate-x-1/2 -translate-y-1/2 z-0 text-white/20 font-poppins font-extrabold"
            >
              {activeData.modal}
            </motion.div>
          </AnimatePresence>
